...
const Properties = () => {
  ...
  // Use only the first property from websiteData
  const property = websiteData.properties[0]; // Show only first property
      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            <span className="text-amber-400">Premium Properties</span> in 
            <span className="text-yellow-400"> Sonipat</span> - Available Now
          </p>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            >
              Connect with our property experts for detailed information and site visits
            </motion.p>
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                onClick={() => navigate('/upcoming-properties')}
              ...
              >
                <span className="relative z-10">VIEW UPCOMING</span>
              </motion.button>
            </motion.div>
          </motion.div>
        </div>
    ...
    >
      ...
      >
        <iframe
          ...
          title="OnePrastha Properties - Background Video"
          frameBorder="0"
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="text-xl font-bold mb-4 text-amber-300">PREMIUM FEATURES</h3>
